...
export const germanierMediaCoverage: MediaCoverage[] = [
    ...
    },
    {
        ...
        excerpt: 'Germanier brought down the curtains with the final event in haute couture in Paris with a rather marvellous show in the Palais de Tokyo.',
        quote: 'The show kicked off magnificently with Lisa Rinna emoting in a midnight blue leotard finished with an enormous tulle skirt and a Madwoman of Chaillot, spiky branch hat.',
        date: '2026-01-30',
        impactScore: 8,
        language: 'en',
        verified: true
    ...
    },
    {
        ...
        verified: true,
        blocksIframe: true,
        ogImage: 'https://wwd.com/wp-content/uploads/2026/01/germanier-spring-2026-hc-couture-bks-mm-001.jpg?w=1000&h=563&crop=1'
    },
    // New sources found 2026-01-31
    {
        ...
        excerpt: 'Germanier closed couture week with Lisa Rinna opening the show and a manifesto on upcycling. Rainbow feathers, beaded masks, and neon tulle filled the runway—every piece crafted from upcycled materials sourced from LVMH\'s most iconic houses.',
        quote: 'I think couture sometimes, it\'s beautiful, but it can be a little too serious. I wanted something really bold.',
        quoteAuthor: 'Kevin Germanier',
        date: '2026-01-29',
        impactScore: 10,
        language: 'en',
        verified: true,
